...
enum opt_code
{
  ...
  OPT_print_multiarch = 1011,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1012,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1013,               /* -print-prog-name= */
  OPT_print_search_dirs = 1014,              /* -print-search-dirs */
  OPT_print_sysroot = 1015,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1016,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1017,                        /* -profile */
  OPT_pthread = 1018,                        /* -pthread */
  OPT_quiet = 1019,                          /* -quiet */
  OPT_r = 1020,                              /* -r */
  OPT_rdynamic = 1021,                       /* -rdynamic */
  OPT_remap = 1022,                          /* -remap */
  OPT_s = 1023,                              /* -s */
  OPT_s_bc_abi = 1024,                       /* -s-bc-abi */
  OPT_save_temps = 1025,                     /* -save-temps */
  OPT_save_temps_ = 1026,                    /* -save-temps= */
  OPT_shared = 1027,                         /* -shared */
  OPT_shared_libgcc = 1028,                  /* -shared-libgcc */
  /* OPT_specs = 1029, */                    /* -specs */
  OPT_specs_ = 1030,                         /* -specs= */
  OPT_static = 1031,                         /* -static */
  OPT_static_libgcc = 1032,                  /* -static-libgcc */
  OPT_static_libgcj = 1033,                  /* -static-libgcj */
  OPT_static_libgfortran = 1034,             /* -static-libgfortran */
  OPT_static_libgo = 1035,                   /* -static-libgo */
  OPT_static_libstdc__ = 1036,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1037, */                /* -std=c++03 */
  OPT_std_c__0x = 1038,                      /* -std=c++0x */
  OPT_std_c__98 = 1039,                      /* -std=c++98 */
  OPT_std_c1x = 1040,                        /* -std=c1x */
  /* OPT_std_c89 = 1041, */                  /* -std=c89 */
  OPT_std_c90 = 1042,                        /* -std=c90 */
  OPT_std_c99 = 1043,                        /* -std=c99 */
  /* OPT_std_c9x = 1044, */                  /* -std=c9x */
  OPT_std_f2003 = 1045,                      /* -std=f2003 */
  OPT_std_f2008 = 1046,                      /* -std=f2008 */
  OPT_std_f95 = 1047,                        /* -std=f95 */
  OPT_std_gnu = 1048,                        /* -std=gnu */
  OPT_std_gnu__0x = 1049,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1050,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1051,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1052, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1053,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1054,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1055, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1056, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1057,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1058, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1059, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1060,                     /* -std=legacy */
  OPT_symbolic = 1061,                       /* -symbolic */
  OPT_t = 1062,                              /* -t */
  OPT_time = 1063,                           /* -time */
  OPT_time_ = 1064,                          /* -time= */
  OPT_tno_android_cc = 1065,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1066,                 /* -tno-android-ld */
  OPT_traditional = 1067,                    /* -traditional */
  OPT_traditional_cpp = 1068,                /* -traditional-cpp */
  OPT_trigraphs = 1069,                      /* -trigraphs */
  OPT_u = 1070,                              /* -u */
  OPT_undef = 1071,                          /* -undef */
  OPT_v = 1072,                              /* -v */
  OPT_version = 1073,                        /* -version */
  OPT_w = 1074,                              /* -w */
  OPT_wrapper = 1075,                        /* -wrapper */
  OPT_x = 1076,                              /* -x */
  OPT_z = 1077,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
