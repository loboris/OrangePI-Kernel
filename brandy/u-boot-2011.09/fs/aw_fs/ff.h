...
FRESULT f_mount (BYTE vol, FATFS* fs, char *part_name);				/* Mount/Unmount a logical drive */
FRESULT f_mount_ex(BYTE vol, FATFS* fs, int  part_index);	    	/* Mount/Unmount a logical drive */
...
DWORD   f_tell(FILE *fp);                                           /* Get the file pointer offset from head */
FRESULT f_eof(FILE *fp);
