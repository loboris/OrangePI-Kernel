...
#define CCM_PLL1_CPUX_TUNING2  	(CCM_BASE+0x038)
#define CCM_PLL5_PLL5_TUNING2 	(CCM_BASE+0x03C)
#define CCM_PLL8_GPU_CTRL 		(CCM_BASE+0x040)

#define CCM_OSC24M_CTRL			(CCM_BASE+0x050)

#define CCM_AHB_APB0_CTRL		(CCM_BASE+0x054)
#define CCM_APB1_CLK_CTRL		(CCM_BASE+0x058)

#define CCM_AHB_GATE0_CTRL		(CCM_BASE+0x060)
#define CCM_AHB_GATE1_CTRL		(CCM_BASE+0x064)
#define CCM_APB0_GATE_CTRL		(CCM_BASE+0x068)
#define CCM_APB1_GATE_CTRL		(CCM_BASE+0x06C)

#define CCM_NAND_SCLK_CTRL		(CCM_BASE+0x080)
#define CCM_MS_SCLK_SCLK_CTRL	(CCM_BASE+0x084)
...
#define CCM_IR0_SCLK_CTRL		(CCM_BASE+0x0b0)
#define CCM_IR1_SCLK_CTRL		(CCM_BASE+0x0b4)
#define CCM_I2S0_SCLK_CTRL		(CCM_BASE+0x0b8)
#define CCM_AC97_SCLK_CTRL		(CCM_BASE+0x0bc)
#define CCM_SPDIF_SCLK_CTRL		(CCM_BASE+0x0c0)
#define CCM_KEYPAD_SCLK_CTRL	(CCM_BASE+0x0c4)
#define CCM_STAT_SCLK_CTRL		(CCM_BASE+0x0c8)
#define CCM_USBPHY_SCLK_CTRL	(CCM_BASE+0x0cc)

#define CCM_SPI3_SCLK_CTRL		(CCM_BASE+0x0d4)
#define CCM_I2S1_SCLK_CTRL		(CCM_BASE+0x0d8)
#define CCM_I2S2_SCLK_CTRL		(CCM_BASE+0x0dc)
...
#define CCM_CSI_SCLK_CTRL		(CCM_BASE+0x0120)
#define CCM_TVD_SCLK_CTRL		(CCM_BASE+0x0128)
...
#define CCM_ACE_SCLK_CTRL		(CCM_BASE+0x0148)
#define CCM_LVDS_SCLK_CTRL		(CCM_BASE+0x014c)
#define CCM_HDMI_SCLK_CTRL		(CCM_BASE+0x0150)
#define CCM_MALI400_SCLK_CTRL	(CCM_BASE+0x0154)
#define CCM_MBUS_SCLK_CTRL0		(CCM_BASE+0x015c)
#define CCM_GMAC_SCLK_CTRL		(CCM_BASE+0x0164)

#define CCM_HDMI1_RST_CTRL		(CCM_BASE+0x0170)
#define CCM_HDMI1_SCLK_CTRL		(CCM_BASE+0x0174)
#define CCM_HDMI1_SLOW_CTRL		(CCM_BASE+0x0178)
#define CCM_HDMI1_REPSET_CTRL	(CCM_BASE+0x017c)
#define CCM_OUTA_SCLK_CTRL		(CCM_BASE+0x01f0)
#define CCM_OUTB_SCLK_CTRL		(CCM_BASE+0x01f4)

#define CCM_AHB_RST_REG0		(CCM_BASE+0x02C0)//a20没有这个寄存器，放在这里不影响
