...
#define TMRC_INT_EN             (TIMER05_BASE + 0x00)
#define TMRC_INT_ST             (TIMER05_BASE + 0x04)

#define TMRC_CTRL(n)            (TIMER05_BASE + 0x10 + 0x10 * (n) + 0x00)
#define TMRC_INTV(n)            (TIMER05_BASE + 0x10 + 0x10 * (n) + 0x04)
#define TMRC_CURNT(n)           (TIMER05_BASE + 0x10 + 0x10 * (n) + 0x08)
